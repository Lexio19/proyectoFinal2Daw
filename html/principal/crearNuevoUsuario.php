...
<body>
    <div class="contenedor-global">
        ...
        <form action="/../controladores/controladorCrearNuevoUsuario.php" method="POST" class="formulario">
            ...
            <button type="submit" name="crearUsuario" class="btn-purple">Crear usuario</button>
        </form>
